...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'Learning Paths plugin',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'learning_paths'),
                os.path.join(root_path, 'learning_paths/migrations')])
